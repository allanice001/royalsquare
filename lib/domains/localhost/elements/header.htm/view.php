<?php
    ...
    echo
		'<table style="border-bottom: solid 2px #39BBEF; width: 100%;" border="0" cellspacing="0" cellpadding="0">' .
			'<tr>' .
				'<td>' .
    ...
    foreach ($menus as $menu) {
		...
		echo
				...
				'</tr>' .
				'<tr>' .
					'<td style="background: url(' . $image_path . 'sub_menu_bg.gif) repeat-x top #39BBEF; padding: 0px 7px 2px 7px; border-left: solid 1px #39BBEF; border-right: solid 1px #39BBEF; border-bottom: solid 1px #39BBEF;">' .
